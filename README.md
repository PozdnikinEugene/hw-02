# Домашнее задание к занятию "`Система мониторинга Zabbix`" - `Поздникинй Евгений`
...
#### Использованые команды
Со сртаницы установки выбираю свою версию ОС.
Скачиваю и запускаю файл установки, указываю сервер в ходе установки.
